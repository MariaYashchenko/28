...
def test_firstname_field_rp_15_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Мариваннааааааа')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_firstname_field_rp_30_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Мариваннаиваннаиваннаааааааааа')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_firstname_field_rp_31_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Мариваннаиваннаиваннааааааааааа')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_firstname_field_rp_501_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('аааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааффффффффффффффффвввввввввввввввввввввввввввввввввввввввввввввваааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааа')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_email_field_rp(driver):
    ...
    email.clear()
    email.send_keys('mv_ivanova@bk.ru')
